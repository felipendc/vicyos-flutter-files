//: Step 6 ok - import the story.dart file into this file.
import 'story.dart';

//: Step 5 ok - Create a new class called StoryBrain.
//: Step 7 ok - Uncomment the lines below to include storyData as a private property in StoryBrain. Hint: You might need to change something in story.dart to make this work.
...
// it should not have any outputs but it should have 1 input called choiceNumber which will be the choice number (int) made by the user.
  ...
  void nextStory(int userChoice) {
    ...
    if (_storyNumber == 0 && userChoice == 1) {
      ...
      _storyNumber = 3;
    } else if (_storyNumber == 3 && userChoice == 1) {
      resetGame();
    }
    // story 2
    else if (_storyNumber == 2 && userChoice == 1) {
      _storyNumber = 5;
    } else if (_storyNumber == 5 && userChoice == 1) {
      resetGame();
...
//: Step 22 - In nextStory() if the storyNumber is equal to 3 or 4 or 5, that means it's the end of the game and it should call a method called restart() "In my case: resetGame()" that resets the storyNumber to 0.
