# Hashes são algoritmos para testar a integridade de arquivos, por exemplo,
#	a empresa Offensive Security é adesenvolvedora do sistema operacional para
#	hackers e profissionais da segurança da informação chamado Kali Linux.

# No site oficial de download das versões do Kali a empresa disponibiliza
#	o SHA256 das imagens dos sitemas (tipo ISO) para que você tenha certeza de que
#	baixou o arquivo original e que ele não foi corrompido no caminho entre os servidores
#	da empresa e o seu computador.

# Site oficial para downloads: https://www.kali.org/downloads/

# IMPORTANTE: O hash de arquivos grandes pode demorar
