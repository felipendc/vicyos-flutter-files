...
if saltar == "S" or saltar == "s":
    ...
    if escolher_lado == "D" or escolher_lado == "d":
        ...
        print("E pra seguir em frente, você terá que nadar para você pra continuar o seu percurso...\n")
        nadar_ou_esperar = input(
            "Você gostaria de nadar ou esperar e descansar? Digite 'E' para esperar e descansar ou 'N' para nadar e seguir em frente.")
        if nadar_ou_esperar == "N" or nadar_ou_esperar == "n":
            ...
            print(
                "e você acabou notando uma casa nos galhos das arvores que continham 3 portas.")
            print(
                "Você escalou a árvore e você decidiu ver oque tinha atrás das portas...")
            print(
            ...
            qual_porta_abrir = input(
                "Qual das portas você deseja abrir primeiro? Digite: 'V' para abrir a porta vermelha, 'A' para abrir a azul ou M para abrir a amarela: ")
